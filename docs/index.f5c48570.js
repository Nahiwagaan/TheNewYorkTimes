...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    if (path.includes("index.html")) {
        loadContent("https://api.nytimes.com/svc/topstories/v2/home.json?api-key=YW2Dl85e3GLnBkYx0gPXXVHxzDYmAatl", "home-section");
        loadContent("https://api.nytimes.com/svc/topstories/v2/arts.json?api-key=YW2Dl85e3GLnBkYx0gPXXVHxzDYmAatl", "arts-section");
    } else if (path.includes("us&science.html")) {
        loadContent("https://api.nytimes.com/svc/topstories/v2/science.json?api-key=YW2Dl85e3GLnBkYx0gPXXVHxzDYmAatl", "science-section");
        loadContent("https://api.nytimes.com/svc/topstories/v2/us.json?api-key=YW2Dl85e3GLnBkYx0gPXXVHxzDYmAatl", "us-section");
    } else if (path.includes("books&world.html")) {
        loadContent("https://api.nytimes.com/svc/topstories/v2/world.json?api-key=YW2Dl85e3GLnBkYx0gPXXVHxzDYmAatl", "world-section");
        loadContent("https://api.nytimes.com/svc/books/v3/lists/current/hardcover-fiction.json?api-key=YW2Dl85e3GLnBkYx0gPXXVHxzDYmAatl", "books-section");
    }
    ...
    fetch(apiUrl).then((response)=>{
        ...
        if (sectionId === "books-section") {
            ...
            if (item.multimedia) {
                ...
                if (!imageAdded) console.log("No image found for item:", item);
            }
            if (sectionDiv.childElementCount > 0) targetSection.appendChild(sectionDiv);
        });
    }).catch((error)=>{
...
},{}]},["aJPIF","8ZNvh"], "8ZNvh", "parcelRequirebd17")
